...
def run_aws_cost_test():
    load_dotenv()


    # Specify your AWS credentials
    aws_access_key_id = aws_access_key_id = os.environ.get('AWS_ACCESS_KEY_ID_TEST_ACC')
